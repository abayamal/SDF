        ...
        <div class="container-fluid"><!--container-fluid -->
            <div class="card card-default"><!--card card-default -->
                <div class="card-header">
                    <h3 class="card-title">Accounts opened in last month</h3>
                </div><!-- /card-header -->
                    ...
                    <?php
                        ...
                        $a=new account();
                        if($a->is_exist_accounts_opened_in_the_last_month($branch_id)){
                            $acc=$a->get_all_accounts_opened_in_last_month($branch_id);
                        ?>
                        ...
                        <?php
                            ...
                            ?>
                        <h3 style="color:red; text-align:center"><b>Not opened saving account in last month!</b></h3>

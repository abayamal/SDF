...
if(isset($_POST['sender']) && isset($_POST['reciever']) && isset($_POST['amount']) && isset($_POST['special_note']) ){
    ...
    include_once "class/c_transaction.php";
       ...
       $t1->special_note=$_POST['special_note'];
       ...
       $t2->special_note=$_POST['special_note'];

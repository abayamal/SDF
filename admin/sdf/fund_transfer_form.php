    ...
    <section class="content-header">
      <div class="container-fluid">
            <div class="card card-default">
                ...
                <!--card body -->
                <div class="card-body">
                    <form action="fund_transfer_form.php" method="post">         
                        <div class="row">
                        <?php
                            ...
                            if(check_acc_num($_POST["from_acc_id"]) && check_acc_num($_POST["to_acc_id"])){
                                if($a->is_exist_account($_POST["from_acc_id"])){
                                    if($a->is_exist_account($_POST["to_acc_id"])){
                                                    ...
                                                    if(!$a->is_hold_account($_POST["from_acc_id"])){
                                                        if($a->account_balance_sufficient($_POST["from_acc_id"],$_POST["amount"])){
                                                            ...
                                                            <table class="table   responsive w-100">
                                                                ...
                                                                <tr>
                                                                    <td>Balance:<?php  echo "<b>LKR. " . number_format($senderAcc->acc_balance,2 , ".", ",<b>"); ?></td>
                                                                    <td>Balance:<?php echo "<b>LKR. " . number_format($ReceiverAcc->acc_balance,2 , ".", ",<b>"); ?></td>
                                                                </tr>
                                                                
                                                                <tr>
                                                                    <td>Transfer Amount:</td>
                                                                    <td id='transfer_amount'><?=$_POST["amount"]?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Note</td>
                                                                    <td id='special_note'><?=$_POST["note"]?></td>
                                        ...
                                        ?>
                                        <div class='alert alert-danger form-group col-md-12' role='alert'>Accounts Numbers are equal ! Please check and try again.</div>
                                        <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"><!--back button-->
                                        <?php
                                        }
                                    ...
                                    ?>
                                    <div class='alert alert-danger form-group col-md-12' role='alert'>Receiver account does not exist.Please check and try again!</div>
                                    <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"><!--back button-->
                                    <?php
                                    ...
                                    ?>
                                    <div class='alert alert-danger form-group col-md-12' role='alert'>Sender account does not exist.Please check and try again!</div>
                                    <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"><!--back button-->
                                    <?php
                                }
                                ...
                                ?>
                                <div class='alert alert-danger form-group col-md-12' role='alert'>Invalid account number! please enter numeric account number.</div>
                                <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"><!--back button-->
                                <?php
                            }
                        ...
                        ?>
                            ...
                            <input class="btn btn-primary btn-sm" type="submit" value="Next" name="submit">
        ...
        $(document).ready(function(){
            ...
            $('#confirm_transfer').click(function(e){ //when button clicked
                ...
                const data ={
                    ...
                    special_note: $('#special_note').html()
                }
                
                //post data with jquery
                //(url, data,).done(what should happen after posting)
                $.post("fund_transfer.php",data).done(function(response){
                    ...
                    if(response.status){
                        ...
                        window.location = "transaction_page.php";});
                    }else{

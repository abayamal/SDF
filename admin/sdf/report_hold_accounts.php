        ...
        <div class="container-fluid"><!--container-fluid -->
            <div class="card card-default"><!--card card-default -->
                <div class="card-header">
                    <h3 class="card-title">Hold accounts</h3>
                </div><!-- /card-header -->
                    ...
                    $a=new account();
                    if($a->is_exist_hold_accounts($branch_id)){

                        $acc=$a->get_all_hold_accounts($branch_id);
                    ?>
                    ...
                    <?php
                        ...
                        ?>
                        <h3 style="color:red; text-align:center"><b>Not available hold accounts!</b></h3>

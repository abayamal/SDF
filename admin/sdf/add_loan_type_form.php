    ...
    <section class="content-header">
      <div class="container-fluid">
            <div class="card card-default">
                ...
                <!--card body -->
                <div class="card-body">
                    <form id="add_loan_type_form" action="add_loan_type_form.php" method="post">         
                        <div class="row">
                        <?php
                        ...
                        ?>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control select2" style="width: 100%" placeholder="Ex: Sihina Niwahana Loan" name="loan_type" required>  
                            </div>
                            ...
                            <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"><!--back button-->
                            <input class="btn btn-primary btn-sm" id="submit" type="submit" value="Add" name="submit" style="margin:2px;">

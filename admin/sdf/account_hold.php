                                                ...
                                                <div class="card text-center"><!--card text-center -->
                                                    ...
                                                    <div class="myDiv2"><!--background color div --> 
                                                        <div class="card-body" style="text-align:left;"><!--card body -->       
                                                            ...
                                                            <a href="account_hold.php?acc_no=<?=$_GET['accNo']?>&type=hold" class="hold btn btn-danger btn-sm">HOLD ACCOUNT</a>

                                                            <a href="account_hold.php?acc_no=<?=$_GET['accNo']?>&type=unhold" class="unhold btn btn-success btn-sm">UNHOLD ACCOUNT</a>
                                                        </div><!-- /.card-body -->
                                    ...
                                    case "hold":
                                        ...
                                        <div class="card text-center"><!--card text-center -->
                                            <div class="card-header">
                                                ...
                                                <div class="myDiv2"><!--background color div --> 
                                                    <div class="card-body" style="text-align:left;"><!--card body -->       
                                        <div class="alert alert-success" role="alert">Account Hold Successfully !</div>
                                        <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"> <!--back button-->
                                                    </div><!-- /.card-body -->
                                                <div><!--/background color div --> 
                                        </div><!--/card text-center -->            
                                    ...
                                    case "unhold":
                                        ...
                                        <div class="card text-center"><!--card text-center -->
                                            <div class="card-header">
                                                ...
                                                <div class="myDiv2"><!--background color div --> 
                                                    <div class="card-body" style="text-align:left;"><!--card body -->       
                                        <div class="alert alert-success" role="alert">Account Unhold Successfully !</div>
                                        <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"> <!--back button-->
                                                    </div><!-- /.card-body -->
                                                <div><!--/background color div --> 
                                        </div><!--/card text-center -->            

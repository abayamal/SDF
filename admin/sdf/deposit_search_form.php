                ...
                <div class="col-md-10"><!--col-md-8-->
                            ...
                            <?php
                                ...
                                switch($_GET["type"]){
                                    ...
                                    case "accDet":
                                        ...
                                        if(check_acc_num($_GET["accNo"])){
                                            if($a->is_exist_account($_GET["accNo"])){
                                                ...
                                                <div class="card text-center"><!--card text-center -->
                                                    ...
                                                    <div class="myDiv2"><!--background color div --> 
                                                        <div class="card-body" style="text-align:left;"><!--card body -->       
                                                            ...
                                                            <a href="deposit_form.php?acc_no=<?=$_GET['accNo']?>" class="next btn btn-primary btn-sm">NEXT</a>
                                                ...
                                                ?>
                                                <div class="alert alert-danger" role="alert">Account does not exist! please enter valid account number.</div>
                                                <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"> <!--back button-->
                                                <?php
                                            ...
                                            ?>
                                            <div class="alert alert-danger" role="alert">Invalid Account Number! please enter valid account number.</div>
                                            <input class="btn btn-info btn-sm" type="submit" value="Back" name="back" style="margin:2px;" onclick="history.go(-1);"> <!--back button-->
                                            <?php
                                        }
                                    ...
                                    case "next":
                                       header( "Location:deposit_form.php?acc_id=" . $a->acc_id );
                                    break; 

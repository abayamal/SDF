        ...
        <div class="container-fluid"><!--container-fluid -->
            <div class="card card-default"><!--card card-default -->
                <div class="card-header">
                    <h3 class="card-title">Daily withdrawals</h3>
                </div><!-- /card-header -->
                    ...
                    $t=new transaction();
                    if($t->is_exist_daily_withdrawals($branch_id)){

                        $with=$t->get_all_daily_withdrawals($branch_id);
                    ?>
                    ...
                    <?php
                        ...
                        ?>
                        <h3 style="color:red; text-align:center"><b>Not available daily withdrawals!</b></h3>

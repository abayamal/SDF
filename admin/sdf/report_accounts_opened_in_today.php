        ...
        <div class="container-fluid"><!--container-fluid -->
            <div class="card card-default"><!--card card-default -->
                <div class="card-header">
                    <h3 class="card-title">Today opened accounts</h3>
                </div><!-- /card-header -->
                    ...
                    if($a->is_exist_account_open_in_today($branch_id)){
                      $acc=$a->get_all_accounts_open_in_today($branch_id);
                    ?>
                    ...
                    <?php
                        ...
                        ?>
                        <h3 style="color:red; text-align:center"><b>Not opened saving account today!</b></h3>
